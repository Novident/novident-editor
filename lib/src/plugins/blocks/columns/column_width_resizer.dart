...
import 'package:novident_editor/src/plugins/blocks/columns/columns_block_constant.dart';
...
class _ColumnWidthResizerState extends State<ColumnWidthResizer> {
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          width: ColumnsBlockConstants.columnWidthResizerWidth,
          color: ColumnsBlockConstants.columnWidthResizerColor,
        ),
      ),
    );
  }
  ...
  void _onHorizontalDragUpdate(DragUpdateDetails details) {
    ...
    final width = columnNode.attributes[ColumnBlockKeys.width] ?? rect.width;
    final newWidth = width + details.delta.dx;
    final transaction = widget.editorState.transaction;
    transaction.updateNode(columnNode, {
      ...columnNode.attributes,
      ColumnBlockKeys.width: newWidth.clamp(
