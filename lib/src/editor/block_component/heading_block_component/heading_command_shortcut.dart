...
final CommandShortcutEvent toggleH1 = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdToggleH1,
...
final CommandShortcutEvent toggleH2 = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdToggleH2,
...
final CommandShortcutEvent toggleH3 = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdToggleH3,
...
final CommandShortcutEvent toggleBody = CommandShortcutEvent(
  key: 'toggle Body',
  getDescription: () => NovidentEditorL10n.current.cmdToggleBody,
