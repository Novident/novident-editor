import 'package:novident_editor/src/infra/editor_svg.dart';
...
void main() {
  group('EditorSvg tests', () {
    testWidgets('EditorSvg w/ Name', (tester) async {
    ...
    testWidgets('EditorSvg w/ Number', (tester) async {
      await tester.buildAndPump(
    ...
    testWidgets('EditorSvg null', (tester) async {
      await tester.buildAndPump(
        const EditorSvg(),
      );
