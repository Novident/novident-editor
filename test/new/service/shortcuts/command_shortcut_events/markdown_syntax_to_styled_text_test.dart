...
void main() async {
  ...
  group('markdown_syntax_to_styled_text.dart', () {
    ...
    group('convert single backquote to code', () {
      testWidgets('`Novident` to code Novident', (tester) async {
        const text = '`Novident';
    ...
    group('convert double tilde to strikethrough', () {
      ...
      testWidgets('~~Novident~~ to strikethrough Novident', (tester) async {
        const text = '~~Novident~';
        final editor = tester.editor..addEmptyParagraph();
        await editor.startTesting();
        await editor.updateSelection(
  ...
  group('convert double underscore to bold', () {
    ...
    testWidgets(
      '__Novident__ to bold Novident',
      ((tester) async {
        const text = '__Novident_';
        final editor = tester.editor..addEmptyParagraph();
        await editor.startTesting();
        await editor.updateSelection(
          Selection.single(path: [0], startOffset: 0),
    ...
    testWidgets(
      '__*Novident__ to bold *Novident',
      ((tester) async {
        const text = '__*Novident_';
        final editor = tester.editor..addEmptyParagraph();
        await editor.startTesting();
        await editor.updateSelection(
          Selection.single(path: [0], startOffset: 0),
