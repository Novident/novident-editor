...
import 'package:novident_editor/src/service/selection/mobile_selection_gesture.dart';
...
class _MobileSelectionServiceWidgetState
  ...
  void updateSelection(Selection? selection) {
    ...
    if (selection != null) {
      if (!selection.isCollapsed) {
        ...
        NovidentEditorLog.selection.debug('update cursor area, $selection');
  ...
  void _onTapUpIOS(TapUpDetails details) {
    ...
    if (_isClickOnSelectionArea(offset)) {
      novidentEditorOnTapSelectionArea.add(0);
      return;
    }
