...
import 'package:novident_editor_rich_text/src/flutter/basic.dart';
...
class RenderParagraph extends RenderBox
  ...
  /// The text to display.
  InlineSpan get text => textPainter.text!;
  ...
  TextAlign get textAlign => textPainter.textAlign;

  set textAlign(TextAlign value) {
    if (textPainter.textAlign == value) {
      return;
    }
  ...
  /// its left.
  TextDirection get textDirection => textPainter.textDirection!;

  set textDirection(TextDirection value) {
    if (textPainter.textDirection == value) {
      return;
    }
  ...
  TextScaler get textScaler => textPainter.textScaler;

  set textScaler(TextScaler value) {
    if (textPainter.textScaler == value) {
      return;
    }
    textPainter.textScaler = value;
    _overflowShader = null;
    markNeedsLayout();
  }
  ...
  set locale(Locale? value) {
    if (textPainter.locale == value) {
      return;
    }
    textPainter.locale = value;
    _overflowShader = null;
    markNeedsLayout();
  }

  /// {@macro flutter.painting.textPainter.strutStyle}
  StrutStyle? get strutStyle => textPainter.strutStyle;

  /// The value may be null.
  set strutStyle(StrutStyle? value) {
    if (textPainter.strutStyle == value) {
      return;
    }
    textPainter.strutStyle = value;
    _overflowShader = null;
    markNeedsLayout();
  }

  /// {@macro flutter.painting.textPainter.textWidthBasis}
  TextWidthBasis get textWidthBasis => textPainter.textWidthBasis;

  set textWidthBasis(TextWidthBasis value) {
    if (textPainter.textWidthBasis == value) {
      return;
    }
    textPainter.textWidthBasis = value;
    _overflowShader = null;
    markNeedsLayout();
  }
  ...
  set textHeightBehavior(ui.TextHeightBehavior? value) {
    if (textPainter.textHeightBehavior == value) {
      return;
    }
    textPainter.textHeightBehavior = value;
    _overflowShader = null;
    markNeedsLayout();
  }
  ...
  @visibleForTesting
  double get preferredLineHeight => textPainter.preferredLineHeight;
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    final GlyphInfo? glyph = textPainter.getClosestGlyphForOffset(position);
    ...
    final InlineSpan? spanHit =
        glyph != null && glyph.graphemeClusterLayoutBounds.contains(position)
            ? textPainter.text!.getSpanForPosition(
  ...
  void performLayout() {
    ...
    final bool didOverflowHeight =
        size.height < textSize.height || textPainter.didExceedMaxLines;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    assert(() {
      textPainter.debugPaintTextLayoutBoxes = debugPaintTextLayoutBoxes;
      return true;
    }());
  ...
  double getFullHeightForCaret(TextPosition position) {
    assert(!debugNeedsLayout);
    _layoutTextWithConstraints(constraints);
    return textPainter.getFullHeightForCaret(position, Rect.zero);
  }
  ...
  List<ui.TextBox> getBoxesForSelection(
    ...
    assert(!debugNeedsLayout);
    _layoutTextWithConstraints(constraints);
    return textPainter.getBoxesForSelection(
      selection,
  ...
  TextPosition _getTextPositionVertical(
    ...
    final Offset caretOffset =
        textPainter.getOffsetForCaret(position, Rect.zero);
      ...
      if (info.isPlaceholder) {
        ...
        while (childConfigsIndex < childConfigs.length &&
            _childConfigBelongsToPlaceholder(
                childConfigs[childConfigsIndex], placeholderIndex)) {
  ...
  SelectionResult _updateSelectionEdgeByTextBoundary(
    ...
    if (_rect.isEmpty) {
      final SelectionResult result =
          SelectionUtils.getResultBasedOnRect(_rect, localPosition);
      _setSelectionPosition(
        result == SelectionResult.next
            ? TextPosition(offset: range.end)
            : TextPosition(
                offset: range.start, affinity: TextAffinity.upstream),
        isEnd: isEnd,
      );
      return result;
    }
    ...
    if (_selectableContainsOriginTextBoundary &&
      ...
      if (positionWithinOriginParagraph) {
        ...
        final int pivotOffset = forwardSelection
            ? originTextBoundary.boundaryEnd.offset
            : originTextBoundary.boundaryStart.offset;
        final shouldSwapEdges = !forwardSelection !=
      ...
      if (existingSelectionEnd != null) {
        ...
        final positionOnPlaceholder = targetParagraph
