...
class MoveIntention {
  ...
  /// Request an animated cursor transition to [target] over [duration].
  /// The editor will not perform its default movement — the renderer is
  /// expected to handle the animation via its [SelectionRenderer] methods.
  const MoveIntention.animated({
    required Position this.target,
    required Duration duration,
    Curve curve = Curves.easeInOut,
  })  : animationDuration = duration,
        animationCurve = curve,
        takeFullControl = true;
