...
/// [NovidentKeyboardService] is responsible for processing shortcut keys,
...
/// ```
///
abstract class NovidentKeyboardService {
...
/// [NovidentKeyboardServiceInterceptor] is used to intercept the keyboard service.
///
/// If the interceptor returns `true`, the keyboard service will not perform
/// the built-in operation.
abstract class NovidentKeyboardServiceInterceptor {
