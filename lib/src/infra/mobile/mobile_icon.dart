...
/// {@tool snippet}
/// All the icons are from NovidentMobileIcons enum.
///
/// ```dart
/// NovidentMobileIcon(
///       afMobileIcons: NovidentMobileIcons.bold,
///       size: 24,
///       color: Colors.black,
///)
/// ```
/// {@end-tool}
class NovidentMobileIcon extends StatelessWidget {
  const NovidentMobileIcon({
    super.key,
  ...
  final NovidentMobileIcons afMobileIcons;
  final double? size;
  final Color? color;
