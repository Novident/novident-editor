...
void main() async {
  ...
  group('white_space_handler.dart', () {
    ...
    //
    // After
    // [h1]Welcome to Novident 😁
    // [h2]Welcome to Novident 😁
    // [h3]Welcome to Novident 😁
    // [h4]Welcome to Novident 😁
    // [h5]Welcome to Novident 😁
    // [h6]Welcome to Novident 😁
    //
    ...
    group('convert double quote to blockquote', () {
      testWidgets('" Novident to blockquote Novident', (tester) async {
        const text = 'Novident';
      ...
      testWidgets('Novident > nothing changes', (tester) async {
        const text = 'Novident >';
        final editor = tester.editor..addParagraph(initialText: '');
        await editor.startTesting();
        await editor.updateSelection(
