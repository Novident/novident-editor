      ...
      timer = Timer(const Duration(milliseconds: 500), () {
        ...
        showDialog<void>(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text(NovidentEditorL10n.current.editLink),
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return NovidentEditorL10n.current.linkTextHint;
              }
              return null;
            },
            decoration: InputDecoration(
              hintText: NovidentEditorL10n.current.linkText,
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return NovidentEditorL10n.current.linkAddressHint;
              }
              return null;
            },
            decoration: InputDecoration(
          ...
          Row(
            ...
            children: [
              TextButton(
                child: Text(
                  NovidentEditorL10n.current.removeLink,
              ...
              TextButton(
                ...
                child: Text(NovidentEditorL10n.current.done),
                onPressed: () async {
