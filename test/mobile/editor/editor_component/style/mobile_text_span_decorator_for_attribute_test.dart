  ...
  group('mobile_text_span_decorator_for_attribute.dart', () {
    group('Link attribute', () {
      testWidgets(
        ...
        (widgetTester) async {
          const text = 'Novident website';
          const address = 'https://appflowy.com/';
          final editor = widgetTester.editor;
          //create a link [Novident website](https://appflowy.com/)
          editor.addParagraph(
            builder: (index) => Delta()
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          await tester.tap(
            find.widgetWithText(
              TextButton,
              NovidentEditorL10n.current.done,
            ),
          );
          await tester.pumpAndSettle(const Duration(seconds: 1));
          // show error prompt
          expect(
            find.text(NovidentEditorL10n.current.linkTextHint),
            findsOneWidget,
          );
          expect(
            find.text(NovidentEditorL10n.current.linkAddressHint),
            findsOneWidget,
          );
        },
      );
      testWidgets(
        ...
        (WidgetTester tester) async {
          const text = 'Novident website';
          const text2 = 'Novident website 2';
          const address = 'https://appflowy.com/';
