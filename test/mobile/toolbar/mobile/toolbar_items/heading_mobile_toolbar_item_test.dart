...
void main() {
  testWidgets('headingMobileToolbarItem', (WidgetTester tester) async {
    ...
    expect(
      find.text(NovidentEditorL10n.current.mobileHeading1),
      findsOneWidget,
    );
    expect(
      find.text(NovidentEditorL10n.current.mobileHeading2),
      findsOneWidget,
    );
    expect(
      find.text(NovidentEditorL10n.current.mobileHeading3),
      findsOneWidget,
    );
    ...
    await tester.tap(
      find.widgetWithText(
        ...
        NovidentEditorL10n.current.mobileHeading1,
      ),
    );
    ...
    await tester.tap(
      find.widgetWithText(
        MobileToolbarItemMenuBtn,
        NovidentEditorL10n.current.mobileHeading2,
      ),
    );
    await tester.pumpAndSettle(const Duration(milliseconds: 500));
    //Get updated node
    ...
    await tester.tap(
      find.widgetWithText(
        MobileToolbarItemMenuBtn,
        NovidentEditorL10n.current.mobileHeading3,
      ),
    );
    await tester.pumpAndSettle(const Duration(milliseconds: 500));
    //Get updated node
