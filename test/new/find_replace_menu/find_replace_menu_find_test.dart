...
import 'package:novident_editor/src/editor/find_replace_menu/find_replace_widget.dart';
...
void main() async {
  ...
  group('find_replace_menu.dart findMenu', () {
    ...
    testWidgets('old matches are unHighlighted when new pattern is searched',
        (tester) async {
      const textLine1 = 'Welcome to Novident 😁';
      const textLine2 = 'Novident is made with Flutter, Rust and ❤️';
      var pattern = 'Welcome';
