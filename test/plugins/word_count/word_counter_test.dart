...
void main() async {
  ...
  group('word_counter_service.dart', () {
    testWidgets('Word and Character count updates', (tester) async {
      ...
      // After inserting the same text at the end of paragraph 0:
      // "Welcome to Novident!Welcome to Novident!" → 5 words (regex \S+
      // treats "Novident!Welcome" as one word — no whitespace between ! and W).
      // Total: 5 (paragraph 0) + 3 + 3 = 11 words.
      expect(service.documentCounters.wordCount, 11);
      expect(service.documentCounters.charCount, 80);
      expect(wordCount, 11);
      expect(charCount, 80);
