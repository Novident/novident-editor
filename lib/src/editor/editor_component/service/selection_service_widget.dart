...
import 'package:novident_editor/src/editor/editor_component/service/selection/desktop_selection_service.dart';
...
class SelectionServiceWidget extends StatefulWidget {
  ...
  final NovidentDropTargetStyle? dropTargetStyle;
...
class _SelectionServiceWidgetState extends State<SelectionServiceWidget>
    ...
    implements NovidentSelectionService {
  final forwardKey = GlobalKey(
    debugLabel: 'forward_to_platform_selection_service',
  );
  NovidentSelectionService get forward =>
      forwardKey.currentState as NovidentSelectionService;
  ...
  Widget build(BuildContext context) {
    if (PlatformExtension.isDesktopOrWeb) {
      return DesktopSelectionServiceWidget(
        ...
        dropTargetStyle:
            widget.dropTargetStyle ?? const NovidentDropTargetStyle(),
        child: widget.child,
      );
    }
