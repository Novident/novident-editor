...
void main() async {
  await NovidentEditorLocalizations.load(
  ...
  testWidgets('wrapp editor with directionality', (tester) async {
    await mockNetworkImagesFor(() async {
      ...
      final editorState = tester
          .widget(find.byType(NovidentEditor))
          .unwrapOrNull<NovidentEditor>()!
          .editorState;
  ...
  Widget build(BuildContext context) {
    final document = Document.blank()
      ..insert(
        [0],
        [
          headingNode(level: 1, delta: Delta()..insert('سلام از Novident')),
