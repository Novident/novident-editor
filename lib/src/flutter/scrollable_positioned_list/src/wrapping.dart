    ...
    switch (scrollCacheExtent.style) {
      case CacheExtentStyle.pixel:
        _calculatedCacheExtent =
            scrollCacheExtent.value < 0 ? null : scrollCacheExtent.value;
        break;
      case CacheExtentStyle.viewport:
        _calculatedCacheExtent =
            mainAxisExtent * scrollCacheExtent.value.clamp(0, double.infinity);
        break;
    }
...
abstract class CustomViewport extends MultiChildRenderObjectWidget {
  ...
  /// The [offset] argument must not be null.
  ///
  /// The [scrollCacheExtent] must be specified if the [cacheExtentStyle] is
  ...
  CustomViewport({
    ...
    this.center,
    this.scrollCacheExtent = const ScrollCacheExtent.pixels(-1),
    ...
    List<Widget> slivers = const <Widget>[],
        ...
        assert(
          scrollCacheExtent?.style != CacheExtentStyle.viewport ||
              scrollCacheExtent?.value != null,
        ),
  ...
  /// See also:
  ///
  ///  * [cacheExtentStyle], which controls the units of the [scrollCacheExtent].
