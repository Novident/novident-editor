...
final CommandShortcutEvent enterInTableCell = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdTableLineBreak,
  command: 'enter',
...
final CommandShortcutEvent leftInTableCell = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n
...
final CommandShortcutEvent upInTableCell = CommandShortcutEvent(
  ...
  getDescription: () =>
      NovidentEditorL10n.current.cmdTableMoveToUpCellAtSameOffset,
  command: 'arrow up',
...
final CommandShortcutEvent downInTableCell = CommandShortcutEvent(
  ...
  getDescription: () =>
      NovidentEditorL10n.current.cmdTableMoveToDownCellAtSameOffset,
  command: 'arrow down',
...
final CommandShortcutEvent tabInTableCell = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdTableNavigateCells,
  command: 'tab',
...
final CommandShortcutEvent shiftTabInTableCell = CommandShortcutEvent(
  ...
  getDescription: () => NovidentEditorL10n.current.cmdTableNavigateCellsReverse,
  command: 'shift+tab',
...
final CommandShortcutEvent backSpaceInTableCell = CommandShortcutEvent(
  ...
  getDescription: () =>
      NovidentEditorL10n.current.cmdTableStopAtTheBeginningOfTheCell,
  command: 'backspace',
