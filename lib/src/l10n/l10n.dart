...
class NovidentEditorLocalizations {
  NovidentEditorLocalizations();

  static NovidentEditorLocalizations? _current;

  static NovidentEditorLocalizations get current {
    assert(_current != null,
        'No instance of NovidentEditorLocalizations was loaded. Try to initialize the NovidentEditorLocalizations delegate before accessing NovidentEditorLocalizations.current.');
    return _current!;
  }

  static const AppLocalizationDelegate delegate = AppLocalizationDelegate();

  static Future<NovidentEditorLocalizations> load(Locale locale) {
    ...
    return initializeMessages(localeName).then((_) {
      ...
      final instance = NovidentEditorLocalizations();
      NovidentEditorLocalizations._current = instance;

      return instance;
    });
  }

  static NovidentEditorLocalizations of(BuildContext context) {
    final instance = NovidentEditorLocalizations.maybeOf(context);
    assert(instance != null,
        'No instance of NovidentEditorLocalizations present in the widget tree. Did you add NovidentEditorLocalizations.delegate in localizationsDelegates?');
    return instance!;
  }

  static NovidentEditorLocalizations? maybeOf(BuildContext context) {
    return Localizations.of<NovidentEditorLocalizations>(
        context, NovidentEditorLocalizations);
  }
...
class AppLocalizationDelegate
    extends LocalizationsDelegate<NovidentEditorLocalizations> {
  ...
  @override
  Future<NovidentEditorLocalizations> load(Locale locale) =>
      NovidentEditorLocalizations.load(locale);
  @override
