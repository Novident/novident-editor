...
void pasteHTML(EditorState editorState, String html) {
  ...
  NovidentEditorLog.keyboard.debug('paste html: $html');
...
void handleCopy(EditorState editorState) async {
  ...
  return NovidentClipboard.setData(
    text: text,
...
void handlePaste(EditorState editorState) async {
  final data = await NovidentClipboard.getData();
...
void _pasteRichClipboard(EditorState editorState, NovidentClipboardData data) {
  if (data.html != null) {
