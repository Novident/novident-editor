...
final List<SelectionMenuItem> standardSelectionMenuItems = [
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.text,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.heading1,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'h1',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.heading2,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'h2',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.heading3,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'h3',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.image,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'image',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.bulletedList,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'bulleted_list',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.numberedList,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'number',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.checkbox,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'checkbox',
      isSelected: isSelected,
      style: style,
  ...
  SelectionMenuItem(
    getName: () => NovidentEditorL10n.current.quote,
    icon: (editorState, isSelected, style) => SelectionMenuIconWidget(
      name: 'quote',
      isSelected: isSelected,
      style: style,
