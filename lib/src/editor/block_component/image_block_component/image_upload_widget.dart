...
class _UploadImageMenuState extends State<UploadImageMenu> {
          ...
          children: [
            Align(
              ...
              child: SizedBox(
                ...
                child: TabBar(
                  tabs: [
                    Tab(text: NovidentEditorL10n.current.uploadImage),
                    Tab(text: NovidentEditorL10n.current.urlImage),
                  ],
  ...
  Widget _buildInvalidLinkText() {
    return Text(
      NovidentEditorL10n.current.incorrectLink,
  ...
  Widget _buildUploadButton(
    ...
    return SizedBox(
      ...
      child: TextButton(
        ...
        child: Text(
          NovidentEditorL10n.current.upload,
          style: TextStyle(
                ...
                : Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          NovidentEditorL10n.current.chooseImage,
                          style: TextStyle(
                            fontSize: 14.0,
                            color: widget.uploadButtonTextColor,
                          ),
