...
void main() async {
  group('delta_html_encoder.dart', () {
    test('bold', () {
      ...
      strong.append(dom.Text('Novident'));
    ...
    test('italic', () {
      ...
      italic.append(dom.Text('Novident'));
    ...
    test('underline', () {
      ...
      underline.append(dom.Text('Novident'));
    ...
    test('href', () {
      ...
      anchor.append(dom.Text('Novident'));
