...
class _FindMenuState extends State<FindMenu> {
  ...
  String message = NovidentEditorLocalizations.current.emptySearchBoxHint;
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: _buildInputDecoration(
              widget.localizations?.find ?? NovidentEditorL10n.current.find,
            ),
          ),
        ),
        ...
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.previousMatch ??
              NovidentEditorL10n.current.previousMatch,
        ),
        // next match button
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.nextMatch ??
              NovidentEditorL10n.current.nextMatch,
        ),
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.close ??
              NovidentEditorL10n.current.closeFind,
        ),
        // regex button
        if (showRegexButton)
          FindAndReplaceMenuIconButton(
            ...
            tooltip: NovidentEditorL10n.current.regex,
          ),
        ...
        if (showCaseSensitiveButton)
          FindAndReplaceMenuIconButton(
            ...
            tooltip: NovidentEditorL10n.current.caseSensitive,
          ),
      ],
    );
  }
  ...
  void _searchPattern() {
    ...
    switch (error) {
      case 'Regex':
        message = NovidentEditorLocalizations.current.regexError;
      case 'Empty':
        message = NovidentEditorLocalizations.current.emptySearchBoxHint;
      default:
        message = widget.localizations?.noResult ??
            NovidentEditorLocalizations.current.noFindResult;
    }
      ...
      children: [
          ...
          child: TextField(
            ...
            decoration: _buildInputDecoration(
              widget.localizations?.replace ??
                  NovidentEditorL10n.current.replace,
            ),
          ),
        ),
        FindAndReplaceMenuIconButton(
        ...
        FindAndReplaceMenuIconButton(
          ...
          tooltip: widget.localizations?.replaceAll ??
              NovidentEditorL10n.current.replaceAll,
        ),
      ],
    );
  }
