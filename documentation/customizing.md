...
Now our 'underscore handler' function is done and the only task left is to inject it into the NovidentEditor.
...
Check out the [complete code](https://github.com/Novident-IO/novident-editor/blob/main/example/lib/samples/underscore_to_italic.dart) file of this example.
...
Now our 'customize style' function is done and the only task left is to inject it into the NovidentEditor.
...
The text direction is LTR by default, but you can change it by wrapping NovidentEditor with Directionality.
