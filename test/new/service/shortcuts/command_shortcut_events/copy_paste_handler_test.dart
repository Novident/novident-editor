...
const plainText = '''NovidentEditor
...
This is a quote!
 Code block
   ...
   Italic two
   Bold tag
You can also use Novident Editor as a component to build your own app.
Awesome features
    ...
    "children": [
      {
        ...
        "data": {
          "delta": [
            {"insert": "NoviNovident Editor is a "},
            {
              "insert": "highly customizable",
              "attributes": {"bold": true},
            },
...
const paragraphhtml =
    "<p>Novident Editor is a <strong>highly customizable</strong>   <i>rich-text editor</i></p>";
const rawHTML =
    '''<h1>NovidentEditor</h1><h2>👋 <strong>Welcome to</strong>   <span style="font-weight: bold; font-style: italic">Novident Editor</span></h2><p>Novident Editor is a <strong>highly customizable</strong>   <i>rich-text editor</i></p><p>   <u>Here</u> is an example <del>your</del> you can give a try</p><p>   <span style="font-weight: bold; font-style: italic">Span element</span></p><p>   <u>Span element two</u></p><p>   <span style="font-weight: bold; text-decoration: line-through">Span element three</span></p><p>   <a href="https://appflowy.io">This is an anchor tag!</a></p><h3>Features!</h3><ul><li>[x] Customizable</li><li>[x] Test-covered</li><li>[ ] more to come!</li><li>First item</li><li>Second item</li><li>List element</li></ul><blockquote>This is a quote!</blockquote><p><code> Code block</code></p><p>   <i>Italic one</i></p><p>   <i>Italic two</i></p><p>   <strong>Bold tag</strong></p><p>You can also use <span style="font-weight: bold; font-style: italic">Novident Editor</span> as a component to build your own app. </p><h3>Awesome features</h3><p>If you have questions or feedback, please submit an issue on Github or join the community along with 1000+ builders!</p><p></p><p></p>''';
const cutData = {
  "document": {
    "type": "page",
    "children": [
