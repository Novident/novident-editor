...
import 'package:novident_editor/src/editor/util/link_util.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          EditorOverlayTitle(
            text: NovidentEditorL10n.current.addYourLink,
          ),
          ...
          if (widget.linkText != null) ...[
            _buildIconButton(
              iconName: 'link',
              text: NovidentEditorL10n.current.openLink,
              onPressed: widget.onOpenLink,
            ),
            _buildIconButton(
              iconName: 'copy',
              text: NovidentEditorL10n.current.copyLink,
              onPressed: widget.onCopyLink,
            ),
            _buildIconButton(
              iconName: 'delete',
              text: NovidentEditorL10n.current.removeLink,
    ...
    return KeyboardListener(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: NovidentEditorL10n.current.urlHint,
        ...
        validator: (value) {
          if (value == null || value.isEmpty || !isUri(value)) {
            return NovidentEditorL10n.current.incorrectLink;
          }
          return null;
        },
      ),
