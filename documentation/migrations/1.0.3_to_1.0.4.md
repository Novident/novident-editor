...
dependencies:
  ...
  # novident_editor_core: ^1.0.0
  # novident_editor_styles: ^1.0.0
  # novident_editor_selection: ^1.0.0
  # novident_editor_rich_text: ^1.0.0
...
```
novident_editor_document → novident_editor_core → novident_editor_styles → novident_editor_selection → novident_editor_rich_text → novident_editor
```
...
| `.../src/core/location/position.dart` | `package:novident_editor_core/novident_core.dart` |
| `.../src/core/location/selection.dart` | `package:novident_editor_core/novident_core.dart` |
| `.../src/render/selection/selectable.dart` | `package:novident_editor_core/novident_core.dart` |
| `.../src/core/style/novident_style_definition.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/novident_style_registry.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/novident_styles_config.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/novident_editor_styles.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/novident_font_provider.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/default_styles.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../src/core/style/novident_table_style_definition.dart` | `package:novident_editor_styles/novident_styles.dart` |
| `.../cursor/cursor.dart` | `package:novident_editor_selection/novident_selection.dart` |
| `.../block_selection_area.dart` | `package:novident_editor_selection/novident_selection.dart` |
| `.../block_selection_container.dart` | `package:novident_editor_selection/novident_selection.dart` |
| `.../rich_text/novident_rich_text.dart` | `package:novident_editor_rich_text/novident_rich_text.dart` |
| `.../rich_text/default_selectable_mixin.dart` | `package:novident_editor_rich_text/novident_rich_text.dart` |
...
// After
// we removed some properties like [lineHeight] or [text]
...
// After
import 'package:novident_editor_core/novident_editor_core.dart';       // SelectableMixin, Position, Selection
import 'package:novident_editor_styles/novident_editor_styles.dart';   // StyleDefinition
import 'package:novident_editor_selection/novident_editor_selection.dart'; // BlockSelectionContainer, Cursor
import 'package:novident_editor_rich_text/novident_editor_rich_text.dart'; // NovidentRichText, DefaultSelectableMixin
```
...
`package:novident_editor_core/novident_editor_core.dart`.
