...
class _TestSelectable extends StatefulWidget {
  ...
  @override
  State<_TestSelectable> createState() => _TestSelectableState();
}
...
class _TestSelectableState extends State<_TestSelectable>
  ...
  @override
  Position getPositionInOffset(Offset start) => Position.invalid();
  @override
  ...
  Offset localToGlobal(Offset offset, {bool shiftWithBaseOffset = false}) =>
      offset;
  @override
  Position start() => Position(path: [0], offset: 0);
  @override
  Position end() => Position(path: [0], offset: 10);
  @override
