...
import 'package:novident_editor/src/flutter/overlay.dart';
...
class NovidentEditor extends StatefulWidget {
  ...
  /// Novident Editor use column as the root widget.
  ///
  ...
  ///
  /// Defaults to [NovidentDropTargetStyle].
  ///
  /// The drop target is rendered in the [NovidentEditor] using the [DesktopSelectionService]
...
class _NovidentEditorState extends State<NovidentEditor> {
  ...
  @override
  void didUpdateWidget(covariant NovidentEditor oldWidget) {
